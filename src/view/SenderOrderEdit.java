 ...
 * @author User
 */
public class SenderOrderEdit extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(SenderOrderEdit.class.getName());

    /**
     * Creates new form AdminOrderEdit
     */
    public SenderOrderEdit() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        Manageuserbutton.setText("Create Order");
        ...
        ManageOrderbutton.setText("My Shipments");
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/logout_1.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new SenderOrderEdit().setVisible(true));
    }
